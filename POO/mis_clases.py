...
class Validacion():
    ...
    def ValidarCampoCodigo2(codigo):
        try:
            if codigo[0:3].isupper() and codigo[0:3].isalpha() and codigo.isalnum() and codigo[3:6].isdigit() and len(codigo) == 6:
                return True
            else:
                return False
        except:
    ...
    def ValidarCampoCantidad(lista):
            try:
                ...
                return False
    def ValidarCampoCantidad2(cantidad):
        try:
            if type(cantidad) == str:
                numero = eval(cantidad)
                if numero % 1 == 0:
                    return True
                else:
                    return False
    ...
    def ValidarCampoPrecio2(precio):
        try:
            if float(precio) % 1 != 0:
                return True
            else:
